                ...
                <tr>
                    ...
                    <td class="text-right">                        
                        ...
                        <?php elseif(isset($url_update_user) and !isset($itemEntity[$primary_key_field])): ?>
                            <a href="<?= site_url(esc($url_update_user.$itemEntity[$primary_key_field_user])) ?>"
                                    class="text-decoration-none" title="<?=lang('common_lang.btn_edit') ?>" >
                                <i class="bi bi-pencil" style="font-size: 20px;"></i>
                            </a>
                        <?php endif ?>
                        ...
                        <?php if (isset($url_delete) && (!isset($itemEntity[$deleted_field]) || empty($itemEntity[$deleted_field]))): ?>
                            <?php if (isset($itemEntity[$primary_key_field]) && !empty($itemEntity[$primary_key_field])): ?>
